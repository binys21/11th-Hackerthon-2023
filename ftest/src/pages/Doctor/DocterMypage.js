    ...
    return (
        <>
            <Wrapper>
                ...
                <UserWrapper>
                <img src={docteruser}></img> <div className="circle"></div>
                <div className='name'>정대만 </div> 
                <br></br>
                <div className='age'>33세 | 남성</div>
                </UserWrapper>

                <LoginInfo>
                    <div className='title'>로그인 정보</div>
                    <hr></hr>
                    <div className='id'>docdoc1234</div>
                </LoginInfo>

                <QList>내가 받은 질문</QList>
                <hr></hr>
                <LogOut>로그아웃</LogOut>
